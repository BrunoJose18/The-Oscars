...
class Application():
    ...
    def criar_widgets(self):
        ...
        label1 = ctk.CTkLabel(self.frame, text="Categoria:")
        label1.grid(row=0, column=0, padx=10)

        self.combo_categoria = ctk.CTkComboBox(self.frame, 
                                            values=["Ator", "Atriz", "Todos"],
                                            command=self.combobox_callback)
        self.combo_categoria.set("Ator")
        self.combo_categoria.grid(row=0, column=1, padx=10)

        label2 = ctk.CTkLabel(self.frame, text="Continente:")
        label2.grid(row=0, column=2, padx=10)

        self.combo_continente = ctk.CTkComboBox(self.frame, 
