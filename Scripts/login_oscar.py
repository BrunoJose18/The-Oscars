...
class Application():
    ...
    def tela_login(self):
        ...
        #Imagem 
        img = PhotoImage(file="Src\ocar.png", width=500, height=500, master=janela) 
        ...
        def tela_register():
            ...
            label = ctk.CTkLabel(master= rg_frame, text="Create your Account", font=("Roboto", 30), text_color="#D8D8D8", width=350, height=80,)
            label.place(x=25, y=5)
