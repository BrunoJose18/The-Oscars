...
class Application():
    ...
    def tela_inicio(self):
        #Imagem de fundo
        img = PhotoImage(file="Src/podio.png", master=janela, width=1000) 
        ...
        janela.iconbitmap("Src/oscares.ico")  # Ícone da janela
        ...
        img1 = PhotoImage(file="Src/lista.png", width=25, height=50, master=janela)
        ...
        img2 = PhotoImage(file="Src/mundio.png", width=100, height=50, master=janela,) 
